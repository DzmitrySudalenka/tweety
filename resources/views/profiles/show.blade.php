<x-app>
    ...
    <header class="mb-6 relative">
        ...
        <p class="text-sm">
            ...
            The name's Bugs. Bugs Bunny. Don't wear it up. Bugs is an anthropomorphic gray
            and white hare or rabbit who is famous for his flippant, insouciant personality.
